...
- **Paper draft** (`paper/`): *Phase Diagrams Without Solvable Models:
  An Empirical Teacher--Student Atlas of Modern Learning Paradigms* —
  LaTeX source, bibliography, and figures, all generated by the
  frontier studies of this repository (`statphys study ...`)
