...
is the reference against which a peak that \emph{does} drift with size, as in
\S\ref{sec:symmetry}, can be read as a measurement rather than as noise in the
analysis.
...
is calibrated rather than permissive. Applied to every other family in the
release --- none of whose answers is known in advance --- it declined to certify
a transition in all of them, and certified the one case that was placed there
precisely because the answer was known.
