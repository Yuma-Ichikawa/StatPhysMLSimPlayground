...
class OrderParamPlotter(Plotter):
    ...
    def plot_from_result(
        ...
        **kwargs: Any,
        ...
        mean_data = np.array(
            result.experiment_results.get(
                "order_params_mean", result.experiment_results.get("trajectories_mean")
            )
        )
        std_data = np.array(
            result.experiment_results.get(
                "order_params_std", result.experiment_results.get("trajectories_std")
            )
        )
