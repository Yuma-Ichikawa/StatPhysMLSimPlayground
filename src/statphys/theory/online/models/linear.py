"""ODE equations for online linear regression (SGD and Ridge)."""
...
class OnlineRidgeEquations(OnlineSGDEquations):
    ...
    This is an alias for OnlineSGDEquations with explicit ridge naming.
    The dynamics are identical - ridge regularization appears as λ in
    the ODE equations.

    Usage:
        equations = OnlineRidgeEquations(rho=1.0, eta_noise=0.1, lr=0.5, reg_param=0.1)
    """
