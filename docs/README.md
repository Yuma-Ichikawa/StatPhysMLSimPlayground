...
| [frontier.md](frontier.md) | Modern paradigms as teacher-student physics: SFT forgetting/transfer, RLHF overoptimization (Goodhart), weak-to-strong generalization, model collapse, ICL emergence — full math, order parameters, and result gallery |
